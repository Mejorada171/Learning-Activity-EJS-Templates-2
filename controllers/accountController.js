...
async function registerAccount(req, res) {
  ...
  if (regResult) {
    req.flash(
      "notice",
      `Congratulations, you\'re registered ${account_name}. Please log in.`
    )
...
async function updateAccountInfo(req, res, next) {
  ...
  if (updateResult) {
    req.flash(
      "notice",
      `${updateResult.account_name}, your account was successfully updated!`
    )
...
async function changePassword(req, res, next) {
  ...
  if (updateResult) {
    req.flash(
      "notice",
      `${updateResult.account_name}, your password was successfully changed!`
    )
    res.redirect("/account/")
  } else {
    req.flash(
